...
<div class="container offset-md-3 ">
	...
	<form  method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
		<div class="insurance-details container-fluid col-lg-6 col-sm-12 bg-white float-left d-inline-block">
			<!-- Car Details-->
		...
		<div class="insurance-pay col-lg-6 col-sm-12 bg-white float-right">
	
	<br>
			<br>
			<!-- INSURANCE COMPANIES-->
			<div class="companies text-center ">  
				<div class="container comapy1">     
				<div class="col-6 bg-white float-left">
					<img height="50px" width="100px" src="img/retina-insurance.png" alt="">
						<br>Pacis Insurance<br>
						Ksh <span id="pacis">20,000 
					</span>
					<br>
					<button class="btn  btn-outline-dark" id="pacisbuy" value="" >BUY</button>
				</div>
	
			<br>
			<br>
				<div class="col-6 bg-white float-right ">
